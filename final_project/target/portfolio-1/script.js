...
function getCauses(){
    ...
    for (var i = 0; i < causes.length; i++){
        ...
        // causeListElement.appendChild(createImageTag(obj.imageUrl));
        // causeListElement.appendChild(createBigTextElement(obj.title));
        // causeListElement.appendChild(createParagraphElement(obj.description));
    }
  });
}
